...
describe("oss-component generator", function () {
	...
	before(function () {
		...
		repoSuffixAnswer = "FreeAllMedia/jargon";
	});
	...
	describe("(with all true)", function () {
		...
		describe("(template context)", function () {
			describe("(general information)", function () {
				...
				it("should set the repo suffix property correctly", function () {
					runningContext.generator.context.repoSuffix.should.equal(repoSuffixAnswer);
				});
